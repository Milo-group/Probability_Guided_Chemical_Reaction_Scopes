...
Contains an analysis from the SI of models with a 10% holdout, where samples from the largest group were randomly excluded before training and used for external validation. 
  
**Variable impact**  
Analysis of the best model, including feature removal analysis with explanations.  
